...
class ParamServer():
    ...
    __params['extrapolation_lines.front_m_min'] = LinearParam(value=0.2, lower=-1.0, upper=1.0)
    __params['extrapolation_lines.front_m_max'] = LinearParam(value=0.8, lower=-1.0, upper=1.0)
